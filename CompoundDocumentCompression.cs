/*
 * This is an excerpt from the EPPlus project, file EPPlus/Utils/CompoundDocument.cs, made July 2, 2016 by Chelsea Hughes
 */
...
namespace OfficeOpenXml.Utils {
    public static class CompoundDocumentCompression {
        /// <summary>
